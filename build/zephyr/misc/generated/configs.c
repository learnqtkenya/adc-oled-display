...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_RASPBERRYPI_PICO_RTC_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_RPI_PICO_RP2040, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_SERIES_RP2040, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CFB_LOG_LEVEL_DBG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CFB_LOG_LEVEL, 4);
